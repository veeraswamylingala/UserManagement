      ...
      function importAll(r) {
       ...
       this.setState({
         ...
         this.globalSearch();
          ...
          var Pdf = importAll(require.context('C:/webreport/daily', false, ));
          var Array = [];
