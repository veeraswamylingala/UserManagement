...
class Map extends React.Component{
    ...
    AssignFrom:date
            ...
            submitHandler = e =>{
                ...
                const convertedstartdate = moment(s.AssignFrom).format('MM/DD/YYYY');
                        s.AssignFrom = convertedstartdate.toString();
                        const convertedDate = moment(s.AssignTo).format('MM/DD/YYYY');
                        s.AssignTo = convertedDate.toString()
                        this.setState({
                            add:s
                        },()=>{
